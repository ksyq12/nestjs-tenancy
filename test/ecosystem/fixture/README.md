...
The graph is intentionally fixed to the current Node 22 CI lane, NestJS 10,
and Prisma 6.19.3, which is the runtime intersection of tenancy, RBAC, outbox,
jobs, and webhook. The package's exact Node 22.13.0 floor and current Node 24
lane are covered by the separate source-gate matrix.
